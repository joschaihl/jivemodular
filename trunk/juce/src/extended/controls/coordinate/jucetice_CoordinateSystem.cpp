...
//----------------------------------------------------------------------------
void CoordinateSystem::paint(JUCE_NAMESPACE::Graphics &g)
{
 if( backgroundImage != NULL )
 {
...
//----------------------------------------------------------------------------
void CoordinateSystem::drawAxisX(JUCE_NAMESPACE::Graphics &g)
{
...
void CoordinateSystem::drawAxisY(JUCE_NAMESPACE::Graphics &g)
{
...
//----------------------------------------------------------------------------
void CoordinateSystem::drawAxisLabelX(JUCE_NAMESPACE::Graphics &g)
{
 if( axisPositionX == INVISIBLE ) 
  return;
...
void CoordinateSystem::drawAxisLabelY(JUCE_NAMESPACE::Graphics &g)
{
 if( axisPositionY == INVISIBLE )
  return;
...
//----------------------------------------------------------------------------
void CoordinateSystem::drawAxisValuesX(JUCE_NAMESPACE::Graphics &g)
{
 if( isLogScaledX == true )
 {
  jassert( verticalCoarseGridInterval >= 1.00001 );
  ...
  while( accumulator < range.getMaxX() )
  {
   ...
   if( axisValuesPositionX == ABOVE_AXIS || axisPositionX == BOTTOM )
    g.drawText(numberString, (int)posX-32, (int)posY-20, 64, 16, 
	      JUCE_NAMESPACE::Justification::centred, false);
   else
...
void CoordinateSystem::drawAxisValuesY(JUCE_NAMESPACE::Graphics &g)
{
 if( isLogScaledY == true )
 {
  jassert( horizontalCoarseGridInterval >= 1.00001 );
  ...
  while( accumulator < range.getMaxX() )
  {
   ...
   if( axisValuesPositionY == LEFT_TO_AXIS )
    g.drawText(numberString, (int)posX-25, (int)posY-10, 20, 20, 
	       JUCE_NAMESPACE::Justification::centredRight, false);
   else
    g.drawText(numberString, (int)posX+4, (int)posY-10, 20, 20, 
	       JUCE_NAMESPACE::Justification::centredLeft, false);
