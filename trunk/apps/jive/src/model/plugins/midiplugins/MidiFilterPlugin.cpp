...
{
//    transform.setTransformCommand (MidiTransform::TransposeNotes); // transpose notes (inadvertently?) eats all CCs
    transform.setTransformCommand (MidiTransform::KeepEvents);
}
