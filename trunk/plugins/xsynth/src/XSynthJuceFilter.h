...
#ifndef XSYNTHJUCEPLUGINFILTER_H
#define XSYNTHJUCEPLUGINFILTER_H

#include "DssiPlugin.h" // for DssiPluginMidiManager
#include "dssi.h"
...
public:
    ...
    const String getParameterXMLName (int index);
