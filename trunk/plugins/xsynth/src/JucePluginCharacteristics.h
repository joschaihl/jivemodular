...
*/
#define JucePlugin_Name                     "XSynth"

/** A longer decription of your plugin.
*/
#define JucePlugin_Desc                     "A 2-oscillator synth"
...
/** A unique four-character code for your plugin.
    ...
    upper-case letter.
*/
#define JucePlugin_PluginCode               'XSyn'
...
/** A prefix for the names of exported entry-point functions that the component exposes.
    ...
    _abcViewEntry
*/
#define JucePlugin_AUExportPrefix           CBR_XSynth

/** This is the same as JucePlugin_AUExportPrefix, but in quotes
    (needed for the resource compiler...)
*/
#define JucePlugin_AUExportPrefixQuoted     "CBR_XSynth"
...
*/
#define JucePlugin_CFBundleIdentifier       "com.google.code.jivemodular.xsynth"
...
*/
#define JucePlugin_AUCocoaViewClassName     CBR_XSynthCocoaView_0
