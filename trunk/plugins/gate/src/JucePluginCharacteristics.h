...
*/
#define JucePlugin_Name                     "Gater"

/** A longer decription of your plugin.
*/
#define JucePlugin_Desc                     "Rhythmic gate effect"
...
*/
#define JucePlugin_ManufacturerCode         'CBRJ'
...
/** A unique four-character code for your plugin.
    ...
    upper-case letter.
*/
#define JucePlugin_PluginCode               'JGat'
...
/** A prefix for the names of exported entry-point functions that the component exposes.
    ...
    _abcViewEntry
*/
#define JucePlugin_AUExportPrefix           JiveGateAU

/** This is the same as JucePlugin_AUExportPrefix, but in quotes
    (needed for the resource compiler...)
*/
#define JucePlugin_AUExportPrefixQuoted     "JiveGateAU"
...
*/
#define JucePlugin_CFBundleIdentifier       "com.cartoonbeats.haszari.Gate"
...
*/
#define JucePlugin_AUCocoaViewClassName     JiveGate_V1
