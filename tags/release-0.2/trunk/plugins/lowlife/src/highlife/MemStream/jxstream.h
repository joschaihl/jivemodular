...
public:
	...
	virtual void Seek(long long const ofs) = 0;
...
public:
	CMemStreamIn(const void *p, dword const s) { assert(p != NULL); Data = (byte *)p; Size = s; Pos = 0; }
	...
	virtual void Seek(long long const o) { Pos += (int)o; }
