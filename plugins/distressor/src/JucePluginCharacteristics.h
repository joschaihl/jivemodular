...
*/
#define JucePlugin_Name                     "Distressor"

/** A longer decription of your plugin.
*/
#define JucePlugin_Desc                     "Compressor with some distortion"

/** The name of your company. (Try to keep this as short as possible)
*/
#define JucePlugin_Manufacturer             "Haszari"
...
/** A unique four-character code for your plugin.
    ...
    upper-case letter.
*/
#define JucePlugin_PluginCode               'HDsC'
...
/** A prefix for the names of exported entry-point functions that the component exposes.
    ...
    _abcViewEntry
*/
#define JucePlugin_AUExportPrefix           HDistressorAU

/** This is the same as JucePlugin_AUExportPrefix, but in quotes
    (needed for the resource compiler...)
*/
#define JucePlugin_AUExportPrefixQuoted     "HDistressorAU"
...
*/
#define JucePlugin_CFBundleIdentifier       "com.google.code.jivemodular.distressor"
...
*/
#define JucePlugin_AUCocoaViewClassName     HDistressor_V1
